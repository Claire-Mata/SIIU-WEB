                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center mt-4">
                                    <h1 class="h2">¡Bienvenido a SIIU!</h1>
                                    <p class="lead">
                                ...
                                <div class="m-sm-4">
                                    <div class="text-center">
                                        <img src="<?= base_url('assets/img/logos/logo1.png') ?>" alt="Logo UES" class="img-fluid rounded" width="110" height="11" />
                                    </div>
                                    <form action="<?= base_url('GetLogin'); ?>" method="POST">
                                        <div class="mb-3">
                                            <label class="form-label">Correo</label>
                                            <input class="form-control form-control-lg" type="email" name="inputEmail" placeholder="Ingrese su correo" />
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Contraseña</label>
                                            <input class="form-control form-control-lg" type="password" name="inputPassword" placeholder="Ingrese su contraseña" />
                                            <small>
